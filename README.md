...
3. Запустите в консоли скрипт через `php index.php`
4. Дождитесь окончания выполнения скрипта
5. Возмите всё содержимое папки output, загрузите к себе на хостинг или в трекер и используйте в качестве вайта
